<%@ Page Language="C#" MasterPageFile="~/TrangChu.Master" AutoEventWireup="true" CodeBehind="PhiGiaoHang.aspx.cs" Inherits="DoAn4.WebForm15" Title="FPT Book" %>
...
<div class="daukhungmain">
    ...
    <div style="text-align:center; color: #FF6600; font-size:large"><b>Địa chỉ nhận hàng ở HCM</b></div>
    <div style="margin:10px">
    Đối với địa chỉ giao hàng tại HCM, chúng tôi miễn phí cước vận chuyển hàng cho khách hàng.
