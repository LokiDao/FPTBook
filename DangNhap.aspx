<%@ Page Language="C#" MasterPageFile="~/TrangChu.Master" AutoEventWireup="true"
    CodeBehind="DangNhap.aspx.cs" Inherits="DoAn4.WebForm4" Title="FPT Book" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Con1" runat="server">
    ...
    <asp:Label ID="Label2" runat="server" Text="FPT Book" Font-Bold="True"></asp:Label>
</div>
    ...
    <p><b>Chào mừng bạn đến với website Book Online</b><br />
        Hiện tại giỏ hàng của bạn chưa có sản phẩm nào! Bạn hãy quay về trang chủ để 
        chọn mua sách&nbsp; mới về!</p>
