<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ThongkeSPbanchaynhat.aspx.cs" Inherits="DoAn4.Admin.WebForm14" Title="FPT Book" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
<center style="font-family: Arial, Helvetica, sans-serif; font-size: large; color: #000000; height: 24px;">
    THỐNG KÊ BÁN HÀNG</center>
    <hr width="50%" />
</div>
<div>
