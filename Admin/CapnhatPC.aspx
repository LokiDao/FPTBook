<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="CapnhatPC.aspx.cs" Inherits="DoAn4.Admin.WebForm7" Title="FPT Book" %>
        ...
        <div>
            <center>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Mã LOẠI SÁCH" SortExpression="Style_ID">
                            <ItemTemplate>
                                <asp:Label ID="lbMa" runat="server" Text='<%# Bind("Style_ID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="TÊN LOẠI SÁCH" SortExpression="Style_Name">
                            <ItemTemplate>
