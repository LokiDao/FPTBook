<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="CapnhatMaloai.aspx.cs" Inherits="DoAn4.Admin.WebForm2" Title="FPT Book" %>
        ...
        <center>
            <div style="height: 373px; width: 794px;">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Mã lĩnh vực" SortExpression="Type_ID">
                            <ItemTemplate>
                                <asp:Label ID="lbMa" runat="server" Text='<%# Bind("Type_ID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Tên lĩnh vực" SortExpression="Type_Name">
                            <ItemTemplate>
