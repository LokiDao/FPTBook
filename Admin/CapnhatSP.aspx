<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="CapnhatSP.aspx.cs" Inherits="DoAn4.Admin.WebForm3" Title="FPT Book" %>
        ...
        <div style="margin-left: 3px; height: 386px;">
            <center>
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    margin-top: 0px;" Width="100%" Height="97%" OnRowEditing="GridView1_RowEditing"
                    OnRowUpdating="GridView1_RowUpdating" PageSize="10">
                    <RowStyle ForeColor="#000066" />
                    <Columns>
                        <asp:TemplateField HeaderText="Mã Sách" SortExpression="Product_ID">
                            <ItemTemplate>
                                <asp:Label ID="lbMa" runat="server" Text='<%# Bind("Product_ID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Tên Sách" SortExpression="Product_Name">
                            <ItemTemplate>
                                <asp:Label ID="Label8" runat="server" Text='<%# Bind("Product_Name") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Lĩnh Vực" SortExpression="Type_ID">
                            <ItemTemplate>
                                <asp:Label ID="Label9" runat="server" Text='<%# Bind("Type_ID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Thể Loại" SortExpression="Style_ID">
                            <ItemTemplate>
