<%@ Page Language="C#" MasterPageFile="~/TrangChu.Master" AutoEventWireup="true" CodeBehind="ThanhToan.aspx.cs" Inherits="DoAn4.WebForm10" Title="FPT Book" %>
...
Để hiểu rõ hơn về cách mua hàng và thanh toán, mời bạn xem mục <a href="Huongdanmuahang.aspx">hướng dẫn mua hàng</a><br />
    Cảm ơn bạn quý khách đã mua hàng tại book online!</p>
</div>
</asp:Panel>
</asp:Content>
